<%@ Page Title="" Language="C#" MasterPageFile="~/PrimeMart.Master" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="PrimeMart.WebForm4" %>
    ...
    <asp:DataList ID="dlProducts" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" CellPadding="10" CssClass="product-container">
        <ItemTemplate>
            <div class="product-card">
                <!-- Image TemplateField -->
                <asp:Image ID="Image1" runat="server" ImageUrl='<%# "~/" + Eval("ImagePath") %>' CssClass="product-image" onerror="this.src='Images/default.jpg';" />
